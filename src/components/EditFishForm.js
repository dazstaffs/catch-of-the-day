...
class EditFishForm extends React.Component{
    ...
    render(){
        ...
        <div className="fish-edit">
            ...
            <select name="status" placeholder="Status" onChange={this.handleChange} value={this.props.fish.status}>
                <option value="available">Fresh</option>
                <option value="unavailable">Sold Out!</option>
            </select>
            <textarea name="desc" placeholder="Desc" onChange={this.handleChange} value={this.props.fish.desc}/>
            <input name="image" type="text" onChange={this.handleChange} placeholder="Image" value={this.props.fish.image}/>
